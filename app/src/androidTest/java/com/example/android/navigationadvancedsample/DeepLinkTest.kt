...
class DeepLinkTest {
    ...
    fun bottomNavView_DeepLink_HandlesIntent_BackGoesToList() {
        ...
        // The example fragment should be shown
        assertExampleFragment()
    ...
    private fun assertExampleFragment() {
        onView(allOf(withText(R.string.title_example), isDescendantOfA(withId(R.id.action_bar))))
            .check(matches(isDisplayed()))
    }
